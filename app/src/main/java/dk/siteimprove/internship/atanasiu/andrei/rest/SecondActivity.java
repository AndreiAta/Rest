...
public class SecondActivity extends AppCompatActivity {
    ...
    static final String API_URL = "https://api.siteimprove.com/v2/sites/73617/analytics/behavior/visit_length";
        ...
        protected void onPostExecute(String response)
        {
            ...
            try {
                ...
                for(int i = 0; i < items.length(); i++)
                {
                    ...
                    String visit_duration_in_minutes = items.getJSONObject(i).getString("visit_duration_in_minutes");
                    allitems = allitems +"Visit duration in minutes: " + visit_duration_in_minutes + "\n" + "Visits: " + visits + "\n\n" ;
                }
